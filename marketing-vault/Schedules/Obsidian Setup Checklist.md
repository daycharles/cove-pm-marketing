...
1. Open `Dashboard.md`.
2. Use Tasks to work the open checklist items.
3. Create notes from `Templates/Session Note.md`, `Templates/Research Note.md`, `Templates/Experiment Note.md`, `Templates/Lead Note.md`, or `Templates/Pilot Note.md`.
4. Capture source URLs and evidence as you work.
5. Put anything involving spend, agreements, pricing, discounts, price locks, or commitments into the approval queue and stop before execution.

## QuickAdd replacement

Use the command palette (`Ctrl/Cmd+P`) to run Templater or Templates. The templates are already written with automatic dates and frontmatter, so QuickAdd is not required for the marketing-agent workflow.
