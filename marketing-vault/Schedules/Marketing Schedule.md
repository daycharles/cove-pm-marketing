...
| LinkedIn publishing and engagement workflow | Weekdays at 8:30 AM and 2:30 PM; evergreen queue at 4:00 PM; engagement at 10:30 AM and 4:00 PM | Public social listening -> prepare distinct timely content and only uncovered evergreen slots; check the 90-day post ledger before approval | Active, approval-gated | 2026-09-20 | Next weekday run | Every post must pass the recent-post uniqueness check; only individually approved Draft text is placed on the Publora calendar; see [[LinkedIn Publishing and Engagement Workflow]] |
