...
| Averion Software Marketing Daily Brief | Weekdays at 7:30 AM America/New_York | Summarize previous-day workbench and marketing-agent sessions | Active | 2026-09-25 | Next weekday run | Stable internal ID: `covepm-marketing-daily-brief`; output in `Sessions/` |
